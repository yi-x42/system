...
const translationTable: Partial<Record<LanguageCode, Record<string, string>>> = {
  ...
  "en-US": {
    ...
    "sidebar.clock.title": "Current Time",
  ...
  "th-TH": {
    ...
    "sidebar.clock.title": "เวลาปัจจุบัน",
  ...
  "vi-VN": {
    ...
    "sidebar.clock.title": "Thời gian hiện tại",
  ...
  "id-ID": {
    ...
    "sidebar.clock.title": "Waktu Saat Ini",
